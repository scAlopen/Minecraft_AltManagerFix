package PVP.AM.microsoft;

import java.io.IOException;

import org.lwjgl.input.Keyboard;

import PVP.AM.SessionChanger;
...
public class GuiLoginMicrosoft extends GuiScreen {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        GuiLoginMicrosoft.drawCenteredString(this.mc.fontRendererObj, "BE AWARE THAT THE PASSWORD ISNT BLURED OUT, AND SO IS THE EMAIL", (int)(this.width / 2), (int)(sr.getScaledHeight() / 1.5 - 1), 12526880);
